...
/* Detección facial múltiple y reconocimiento en tiempo real
Uso de la plataforma cruzada .Net de EmguCV en la biblioteca de procesamiento de imágenes de Intel OpenCV para C # .Net
Creditos para Sergio Andrés Guitérrez Rojas
Sergiogut1805@hotmail.com , Bucaramanga-Colombia
Modificaciones por:
Cesar Adrian Arteaga Mendoza &&
José Maria Gayosso Ortega  ,  Hidalgo- México */
...
namespace MultiFaceRec
{
    public partial class FrmPrincipal : Form
    {
        ...
        private void entrenarBD(Image<Gray, byte> gray,String emocion)
        {
            ...
            TrainedFace = gray2.Resize(100, 100, Emgu.CV.CvEnum.INTER.CV_INTER_CUBIC);
        ...
        private void habilitarDetecciónToolStripMenuItem_Click(object sender, EventArgs e)
        {
